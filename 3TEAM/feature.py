...
feature_cols = ['attack_vector', 'attack_complexity','privileges_required', 'user_interaction']
...
feature_prefixes = ['attack_vector_', 'attack_complexity_',
                     'privileges_required_', 'user_interaction_']
