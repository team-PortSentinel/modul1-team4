...
def _parse_raw_text(scan_input):
    """
...
def _extract_services(scan_input):
    """
...
def _to_dashboard_format(team2_result):
    """
...
# ── ③ app.py가 호출할 단일 진입점 ──────────────────────────────────────
def run_vulnerability_scan(scan_input, max_cves=5):
    """
